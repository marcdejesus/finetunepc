...
export async function POST(request: NextRequest) {
  try {
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .service-details { background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #667eea; }
        ...
        <body>
          <div class="header">
            ...
            <p>Your service request has been successfully scheduled</p>
          </div>
          
          <div class="content">
            <p>Dear ${userName || 'Valued Customer'},</p>
            
            <p>Thank you for choosing Fine Tune PC for your ${serviceTypeNames[service.type]} needs. Your service booking has been confirmed with the following details:</p>
            ...
            <div class="service-details">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value priority-${service.priority.toLowerCase()}">${priorityLabels[service.priority]}</span>
              </div>
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">${service.issueDetails}</span>
              </div>
              ` : ''}
            </div>
            ...
            <div class="important-note">
              ...
              <ul>
                ...
                <li>Bring your device and any relevant accessories</li>
            ...
            <p>You can manage your service booking or view additional details by visiting your account dashboard.</p>
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: [userEmail],
      subject: `Service Booking Confirmed - ${serviceTypeNames[service.type]} on ${formattedDate}`,
      html: emailHtml,
    })
